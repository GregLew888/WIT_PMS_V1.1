@extends('layouts.app', ['class' => 'login-page', 'page' => _('Login Page'), 'contentClass' => 'login-page','pageSlug' => 'dashboard'])
@section('css')
<style>
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body mt-5">
                    ...
                    <div class="{{ $errors->has('password') ? ' has-danger' : '' }}">
                        ...
                        <span id="toggle_pwd_login" class="fa fa-fw fa-eye field_icon" style="margin-top: -25px;margin-right: 0px;cursor: pointer;z-index: 2;position: absolute;right: 25px;"></span>
